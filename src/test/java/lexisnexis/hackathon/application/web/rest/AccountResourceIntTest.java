package lexisnexis.hackathon.application.web.rest;
import lexisnexis.hackathon.application.config.Constants;

import lexisnexis.hackathon.application.LexisNexisHack2017App;
import lexisnexis.hackathon.application.domain.Authority;
import lexisnexis.hackathon.application.domain.User;
import lexisnexis.hackathon.application.repository.AuthorityRepository;
import lexisnexis.hackathon.application.repository.UserRepository;
import lexisnexis.hackathon.application.security.AuthoritiesConstants;
import lexisnexis.hackathon.application.service.MailService;
import lexisnexis.hackathon.application.service.UserService;
import lexisnexis.hackathon.application.service.dto.UserDTO;
import lexisnexis.hackathon.application.web.rest.vm.KeyAndPasswordVM;
import lexisnexis.hackathon.application.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = LexisNexisHack2017App.class)
